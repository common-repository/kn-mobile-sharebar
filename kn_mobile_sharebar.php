...
* Plugin URI: http://www.botalab.net
	...
	if ( $visibility_homepage || $visibility_single || $visibility_page ) {
		...
		<div id="mobile-share-box'.get_option( 'kn_mobile_sharebar_where' ).'" style="height: '.get_option( 'kn_mobile_sharebar_height' ).'px;">
			<ul id="horizontal-list" style="height: '.get_option( 'kn_mobile_sharebar_height' ).'px;">
				...
				<li class="knws" style="height: '.get_option( 'kn_mobile_sharebar_height' ).'px;"><a href="https://api.whatsapp.com/send?text='.$whatsapp_text_fix.'" target="_blank" class="hyperlink" style="height: '.get_option( 'kn_mobile_sharebar_height' ).'px;">whatsapp</a></li>
			</ul>
		</div>
